...
from app.ingestion.database_loader import (
    load_extracted_medicines_to_database,
    load_processed_chunks_to_database,
)
...
def main() -> None:
    ...
    with SessionLocal() as db:
        ...
        medicines_summary = load_extracted_medicines_to_database(db)

    print(
        {
            "procesamiento": manifest,
            "base_datos": db_summary,
            "medicamentos_extraidos": medicines_summary,
        }
    )
